import type { CodeChunk } from "../types/review";
...
export function saveChunksToPinecone(namespace: string, chunks: CodeChunk[]) {
  ...
  return index.namespace(namespace).upsertRecords({ records });
}
